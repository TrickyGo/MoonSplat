import lietorch
import torch
from tracking.frame import SharedKeyframes
from tracking.geometry import (
    constrain_points_to_ray,
)
from tracking.mast3r_utils import mast3r_match_symmetric
...
class FactorGraph:
    ...
    def solve_GN_rays(self):
        ...
        tracking_backends.gauss_newton_rays(
            pose_data,
            Xs,
            Cs,
            ii,
    ...
    def solve_GN_calib(self):
        ...
        tracking_backends.gauss_newton_calib(
            pose_data,
            Xs,
            Cs,
            K,
